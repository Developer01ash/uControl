...
@interface ControlVisibility : NSObject
@property (nonatomic) BOOL mobileSmall;
@property (nonatomic) BOOL mobileLarge;
@property (nonatomic) BOOL tabletSmall;
@property (nonatomic) BOOL tabletLarge;
