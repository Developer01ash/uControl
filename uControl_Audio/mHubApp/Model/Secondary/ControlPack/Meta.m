...
+(Meta*) getObjectFromDictionary:(NSDictionary*)dictResp {
    ...
    @try {
        if ([dictResp isKindOfClass:[NSDictionary class]]) {
            ...
            objReturn.type = [Utility checkNullForKey:kCPControlType Dictionary:dictResp];
...
- (void)encodeWithCoder:(NSCoder *)encoder {
    @try {
        ...
        [encoder encodeObject:self.type forKey:kCPControlType];
    }
    @catch(NSException *exception) {
        [[AppDelegate appDelegate] exceptionLog:exception Function:__PRETTY_FUNCTION__ Line:__LINE__];
    }
...
- (id)initWithCoder:(NSCoder *)decoder {
    @try {
        if(self = [super init]) {
            ...
            self.type           = [decoder decodeObjectForKey:kCPControlType];
