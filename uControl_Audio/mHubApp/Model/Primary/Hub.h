...
@property(nonatomic, retain) NSString *hubName_InStack;
@property(nonatomic, assign) HubModel Generation;
@property(nonatomic, retain) NSString *modelName;
@property(nonatomic, assign) BOOL BootFlag;
@property(nonatomic, assign) BOOL webSocketFlag;
...
@property(nonatomic) NSInteger AVRCount;
...
@property(nonatomic, retain) NSMutableArray <InputDevice*>*HubInputDataAudioInStandalone;    // Array of Audio InputDevice type
...
@property(nonatomic, retain) NSMutableArray <Controls*>*HubControlsList;    // Array of Control type
...
@property(nonatomic, retain) NSDictionary *HubCECData;  // Dictionary of CEC data type
