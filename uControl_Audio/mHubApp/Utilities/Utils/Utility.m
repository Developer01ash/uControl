...
+(DeviceType) deviceType {
    @try {
      ...
      //  NSLog(@"deviceSizeDiagonal 1 %f %d ",size,fabs((double)[[UIScreen mainScreen]bounds].size.height-(double)844) < DBL_EPSILON);
        DeviceType deviceType = mobileLarge;
        if (IS_IPHONE_4_HEIGHT || IS_IPHONE_5_HEIGHT || IS_IPHONE_6_HEIGHT || size < 667) {
            deviceType = mobileSmall;
        } else if (IS_IPHONE_6_PLUS_HEIGHT || IS_IPHONE_X_HEIGHT || IS_IPHONE_XR_HEIGHT || (size > 667 && size < 1024)) {
...
+(DeviceType) deviceTypeByScreenSize {
    @try {
        ...
        DeviceType deviceType = mobileLarge;
        NSLog(@"deviceSizeDiagonal 2 %f ",size);
...
+(NSString *)integerToCharacter:(NSInteger)intNum {
    @try {
        ...
        {
            intNum = intNum - 26;
            char charReturnObj = (intNum+96);
            NSString *charReturn= [NSString stringWithFormat:@"%c%c",charReturnObj,charReturnObj];
            //NSLog(@"doubleCharStr %@",charReturn);
            return charReturn;
        }
        else{
        char charReturnObj = (intNum+96);
        // DDLogDebug(@"Int %ld == %c", (long)intNum, charReturn);
        NSString *charReturn = [NSString stringWithFormat:@"%c",charReturnObj];
        return charReturn;
        }
    }
    @catch(NSException *exception) {
...
+(NSInteger)characterToInteger:(NSString*)string {
    @try {
        if ([string isValidNumeric]) {
            ...
            if(string.length > 1)
            {
                int asciiCode = [[string lowercaseString] characterAtIndex:1];
                int intReturn = (asciiCode-96);
                intReturn = intReturn + 26;
                 return intReturn;
            }
            else{
...
{
    //{"control":{"switch":{"output":{"id":"a", "input":"1"}}}}
    NSMutableDictionary *dict_switch = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_control = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_output = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_values = [@{@"id": outputobj, @"input" : inputObj} mutableCopy];
    [dict_output setValue:dict_values forKey:@"output"];
    [dict_switch setValue:dict_output forKey:@"switch"];
    [dict_control setValue:dict_switch forKey:@"control"];
    NSLog(@"main dict inputswitch%@",dict_control);
   NSError *error;
    NSString *jsonString;
   NSData *jsonData = [NSJSONSerialization dataWithJSONObject:dict_control
   ...
   if (! jsonData) {
       ...
       //NSLog(@"main dict jsonString%@",jsonString);
       return  jsonString;
   }
}
...
{
    //{"control":{"switch":{"zone":{"id":"z3", "input":"25"}}}}
    NSMutableDictionary *dict_switch = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_control = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_zone = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_values = [@{@"id": idObj, @"input" : inputObj} mutableCopy];
    [dict_zone setValue:dict_values forKey:kZONE];
    [dict_switch setValue:dict_zone forKey:@"switch"];
    [dict_control setValue:dict_switch forKey:@"control"];
    NSLog(@"main dict zone switch%@",dict_control);
   NSError *error;
    NSString *jsonString;
   NSData *jsonData = [NSJSONSerialization dataWithJSONObject:dict_control
                                                      options:NSJSONWritingPrettyPrinted // Pass 0 if you don't care about the readability of the generated string
...
{
    //{"command":{"ir":{"port":"1", "id":"23"}}}
   // {"command":{"ir":{"port":"1", "id":"23", "state":"hold"}}}
   // "command":{"ir":{"port":"1", "id":"23", "state":"release"}}}
    NSMutableDictionary *dict_command = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_ir = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_values ;
    switch (objTouchType) {
        case Normal:
            dict_values = [@{@"port": portObj, @"id" : idObj} mutableCopy];
            break;
        case Hold:
            dict_values = [@{@"port": portObj, @"id" : idObj,@"state":@"hold"} mutableCopy];
            NSLog(@"main dict IR command%@",dict_values);
            break;
        case Release:
            dict_values = [@{@"port": portObj, @"id" : idObj,@"state":@"release"} mutableCopy];
            break;
        default:
            dict_values = [@{@"port": portObj, @"id" : idObj} mutableCopy];
            break;
...
//    dict_values = [@{@"port": portObj, @"id" : idObj} mutableCopy];
    [dict_ir setValue:dict_values forKey:@"ir"];
    [dict_command setValue:dict_ir forKey:@"command"];
    NSLog(@"main dict IR command%@",dict_command);
   NSError *error;
    NSString *jsonString;
   NSData *jsonData = [NSJSONSerialization dataWithJSONObject:dict_command
                                                      options:NSJSONWritingPrettyPrinted // Pass 0 if you don't care about the readability of the generated string
                                                        error:&error];
   if (! jsonData) {
       NSLog(@"Got an error: %@", error);
...
+(NSString *)createJSONFor_HOLD_IRCommand:(NSString *)portObj ID:(NSString *)idObj
{
    //{"command":{"ir":{"port":"1", "id":"23"}}}
    NSMutableDictionary *dict_command = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_ir = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_values = [@{@"port": portObj, @"id" : idObj,@"state":@"hold"} mutableCopy];
    [dict_ir setValue:dict_values forKey:@"ir"];
    [dict_command setValue:dict_ir forKey:@"command"];
    NSLog(@"main dict IR Hold command%@",dict_command);
   NSError *error;
    NSString *jsonString;
   NSData *jsonData = [NSJSONSerialization dataWithJSONObject:dict_command
                                                      options:NSJSONWritingPrettyPrinted // Pass 0 if you don't care about the readability of the generated string
...
+(NSString *)createJSONFor_RELEASE_IRCommand:(NSString *)portObj ID:(NSString *)idObj
{
    //{"command":{"ir":{"port":"1", "id":"23"}}}
    NSMutableDictionary *dict_command = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_ir = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_values = [@{@"port": portObj, @"id" : idObj,@"state":@"release"} mutableCopy];
    [dict_ir setValue:dict_values forKey:@"ir"];
    [dict_command setValue:dict_ir forKey:@"command"];
    NSLog(@"main dict IR Hold command%@",dict_command);
   NSError *error;
...
{
    //CEC Command
    //{"command":{"cec":{"port":"a", "type":"1", "id":"0"}}}
    NSMutableDictionary *dict_command = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_cec = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_values = [@{@"port": portObj, @"type" : typeObj,@"id" : idObj} mutableCopy];
    [dict_cec setValue:dict_values forKey:@"cec"];
    [dict_command setValue:dict_cec forKey:@"command"];
    NSLog(@"main dict CEC Command%@",dict_command);
   NSError *error;
    NSString *jsonString;
   NSData *jsonData = [NSJSONSerialization dataWithJSONObject:dict_command
                                                      options:NSJSONWritingPrettyPrinted // Pass 0 if you don't care about the readability of the generated string
...
{
    //ARC
    //{"control":{"arc":{"id":"a", "type":"1", "state":"true"}}}
    NSMutableDictionary *dict_control = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_arc = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_values = [@{@"port": portObj, @"type" : typeObj,@"state" : stateObj} mutableCopy];
    [dict_arc setValue:dict_values forKey:@"arc"];
    [dict_control setValue:dict_arc forKey:@"control"];
    NSLog(@"main dict ARC Command%@",dict_control);
   NSError *error;
    NSString *jsonString;
   NSData *jsonData = [NSJSONSerialization dataWithJSONObject:dict_control
                                                      options:NSJSONWritingPrettyPrinted // Pass 0 if you don't care about the readability of the generated string
...
{
    //Volume Control (zone)
   // {"control":{"volume":{"zone":{"id":"z1", "level":"40"}}}}
    NSMutableDictionary *dict_volume = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_zone = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_control = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_values = [@{@"id": zoneIDObj, @"level" : levelObj} mutableCopy];
    [dict_zone setValue:dict_values forKey:@"zone"];
    [dict_volume setValue:dict_zone forKey:@"volume"];
    [dict_control setValue:dict_volume forKey:@"control"];
    NSLog(@"main dict volume control zone%@",dict_control);
   NSError *error;
    NSString *jsonString;
   NSData *jsonData = [NSJSONSerialization dataWithJSONObject:dict_control
                                                      options:NSJSONWritingPrettyPrinted // Pass 0 if you don't care about the readability of the generated string
...
{
    //Volume Control
   // {"control":{"volume":{"output":{"id":"y", "level":"30"}}}}
    NSMutableDictionary *dict_volume = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_output = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_control = [[NSMutableDictionary alloc]init];
    NSMutableDictionary *dict_values = [@{@"id": outputIDObj, @"level" : levelObj} mutableCopy];
    [dict_output setValue:dict_values forKey:@"output"];
    [dict_volume setValue:dict_output forKey:@"volume"];
    [dict_control setValue:dict_volume forKey:@"control"];
    NSLog(@"main dict volume control zone%@",dict_control);
   NSError *error;
    NSString *jsonString;
...
{
    //Mute
   //{"control":{"mute":{"output":{"id":"y", "state":"true"}}}}
        NSMutableDictionary *dict_output = [[NSMutableDictionary alloc]init];
        NSMutableDictionary *dict_mute = [[NSMutableDictionary alloc]init];
        NSMutableDictionary *dict_control = [[NSMutableDictionary alloc]init];
        NSMutableDictionary *dict_values = [@{@"id": idObj, @"state" : stateObj} mutableCopy];
        [dict_output setValue:dict_values forKey:@"output"];
        [dict_mute setValue:dict_output forKey:@"mute"];
        [dict_control setValue:dict_mute forKey:@"control"];
        NSLog(@"main dict mute %@",dict_control);
       NSError *error;
        NSString *jsonString;
       NSData *jsonData = [NSJSONSerialization dataWithJSONObject:dict_control
                                                          options:NSJSONWritingPrettyPrinted // Pass 0 if you don't care about the readability of the generated string
...
{
    //Mute (zone)
   // {"control":{"mute":{"zone":{"id":"z1", "state":"true"}}}}
        NSMutableDictionary *dict_zone = [[NSMutableDictionary alloc]init];
        NSMutableDictionary *dict_mute = [[NSMutableDictionary alloc]init];
        NSMutableDictionary *dict_control = [[NSMutableDictionary alloc]init];
        NSMutableDictionary *dict_values = [@{@"id": zoneIdObj, @"state" : stateObj} mutableCopy];
        [dict_zone setValue:dict_values forKey:@"zone"];
        [dict_mute setValue:dict_zone forKey:@"mute"];
        [dict_control setValue:dict_mute forKey:@"control"];
        NSLog(@"main dict mute zone%@",dict_control);
       NSError *error;
        NSString *jsonString;
       NSData *jsonData = [NSJSONSerialization dataWithJSONObject:dict_control
                                                          options:NSJSONWritingPrettyPrinted // Pass 0 if you don't care about the readability of the generated string
...
{
    //Sync
    //{"control":{"sync":{"id":"zone"}}}
   
        NSMutableDictionary *dict_control = [[NSMutableDictionary alloc]init];
        NSMutableDictionary *dict_sync = [[NSMutableDictionary alloc]init];
        NSMutableDictionary *dict_values = [@{@"id" : idObj} mutableCopy];
        [dict_sync setValue:dict_values forKey:@"sync"];
        [dict_control setValue:dict_sync forKey:@"control"];
        NSLog(@"main dict Sync%@",dict_control);
       NSError *error;
        NSString *jsonString;
       NSData *jsonData = [NSJSONSerialization dataWithJSONObject:dict_control
                                                          options:NSJSONWritingPrettyPrinted // Pass 0 if you don't care about the readability of the generated string
