...
- (void)netServiceBrowser:(NSNetServiceBrowser *)serviceBrowser didFindService:(NSNetService *)service moreComing:(BOOL)moreComing {
    ...
    @try {
        ...
        //for(NSString * toContain in [NSArray arrayWithObjects:@"mhub", @"hda", @"hdanywhere", @"hd", nil]){
         NSLog(@"service.name %@ %@ %@",service.name,service.addresses,service);
        
        //New Code for service name to Find Mhub devices with specific model name.
      
        NSArray *devicesArr = [[NSArray alloc]initWithObjects:@"MHUB4K88PRO", @"MHUB4K44PRO" , @"MHUB4K431",@"MHUB4K862", @"MHUB431U" ,@"MHUB862U",@"MHUBPRO4440",@"MHUBPRO8840", @"MHUBMAX44",@"MHUBMAX88",@"MHUBAUDIO64",@"MHUBPRO24440",@"MHUBPRO288100",@"MHUBU41140",@"ZP5",@"ZP1",@"MHUBS888100",@"MHUBU43140",@"MHUBU86240", nil];
      //  NSArray *devicesArr = [[NSArray alloc]initWithObjects: @"MHUB4K431",@"MHUB4K862", nil];
